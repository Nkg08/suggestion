...
<body>
    ...
    <div>
        <nav>
            <div class="logo">
                <a href="/index.html"><img src="/img/NTPC-Logo.png" alt="Logo"></a>
            </div>
            <div class="head-blink">
                <h1 >Online Suggestion Scheme</h1>
            </div>
    ...
    <div class="main-body" >
        <div class="sidebar">
            <h4>Navigation</h4>
            <div class="sidebar-btn" style="background-color: #7067C2;">
                <div class="sidebar-btn--">
                    
                    <a href="/Submit/index.html"><img src="/img/discussion.png" alt="" style="width: 24px;
                        height: 24px;
                        margin-right: 10px;">Submit Your Suggestion</a>
                </div>
                <div class="sidebar-btn--">
                    <a href="/viewYour/index.html"><img src="/img/discussion.png" alt="" style="width: 24px;
                        height: 24px;
                        margin-right: 10px;">View Your Suggestion</a>
                </div>
            </div>
        </div>
...
<head>
    ...
    <title>Reports</title>
    <link rel="stylesheet" href="/Suggestion/Submit/viewAlll.css?v=7">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    ...
    <div>
        ...
        <div class="header">
            ...
            <div class="header-right">
                ...
                <a href="#contact" class="hvr-icon-buzz-out">Logout <i class="fa fa-lock hvr-icon"></i></a>
        ...
        <table class="styled-table">
            <thead>
                <tr>
                    ...
                    <th>Impact Options</th>
                    <th>Any Other Improvement</th>
                    <th>Saving Status</th>
